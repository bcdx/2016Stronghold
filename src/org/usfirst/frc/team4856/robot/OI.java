...
public class OI {
	...
	public OI() {
	 ...
	 JoystickButton pushBall = new JoystickButton(shooterStick, 6);
	 JoystickButton grabBall = new JoystickButton(shooterStick, 7);
	...
	// Up.whileHeld(new LiftElevator());
	 ...
	 pushBall.whileHeld(new Push());
	 grabBall.whileHeld(new Pull());
